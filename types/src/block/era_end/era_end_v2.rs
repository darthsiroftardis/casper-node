...
pub struct EraEndV2 {
    ...
    pub(super) new_era_gas_price: u64,
}
...
impl EraEndV2 {
    ...
    pub fn new_era_gas_price(&self) -> u64 {
...
impl ToBytes for EraEndV2 {
    fn write_bytes(&self, writer: &mut Vec<u8>) -> Result<(), bytesrepr::Error> {
        ...
        new_era_gas_price.write_bytes(writer)?;
        Ok(())
    }
    ...
    fn serialized_length(&self) -> usize {
        ...
        equivocators.serialized_length()
            ...
            + new_era_gas_price.serialized_length()
    }
}
...
impl FromBytes for EraEndV2 {
    fn from_bytes(bytes: &[u8]) -> Result<(Self, &[u8]), bytesrepr::Error> {
        ...
        let (new_era_gas_price, bytes) = u64::from_bytes(bytes)?;
